...
$breadcrumb = 'Customer Service » Petugas Desa';
?>
...
@section('content')
  <ul class="nav nav-tabs style-2 mb-4" id="pills-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
      <a href="{{ route('users.petugasdesa') }}" class="nav-link active bg-primary text-white">
        <i class="la la-user-friends me-2 text-white"></i>
        Petugas Desa
      </a>
    </li>
    <li class="nav-item" role="presentation">
              ...
              <tr>
                ...
                <td>
                  <a type="button" class="btn btn-primary shadow btn-xs sharp me-1 btn-edit" data-bs-toggle="offcanvas"
                    data-bs-target="#editCSpetugasdesa{{ $user->id }}">
