...
$breadcrumb = 'Customer Service » Kepala Dinas';
?>
...
@section('content')
  <ul class="nav nav-tabs style-2 mb-4" id="pills-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
      <a href="{{ route('users.kadis') }}" class="nav-link active bg-primary text-white">
        <i class="la la-user-tie me-2 text-white"></i>
        Kepala Dinas
      </a>
    </li>
    <li class="nav-item" role="presentation">
      <a type="button" class="nav-link bg-primary-subtle bg-gradient" data-bs-toggle="offcanvas"
        data-bs-target="#tambahKadis">
        + Tambah Kadis
      </a>
    </li>
  </ul>
  <div class="offcanvas offcanvas-end" tabindex="-1" id="tambahKadis" aria-labelledby="offcanvasLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasLabel">Tambah CS-Kadis</h5>
              ...
              <tr>
                ...
                <td>
                  <a type="button" class="btn btn-primary shadow btn-xs sharp me-1 btn-edit" data-bs-toggle="offcanvas"
                    data-bs-target="#editCSkadis{{ $user->id }}">
